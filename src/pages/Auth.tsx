...
import { Eye, EyeOff, Mail, Lock, User, ArrowLeft, GraduationCap, Loader2 } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {!isLogin && (
              <>
                ...
                <div className="flex items-center space-x-2 pt-2">
                  ...
                  />
                  <Label htmlFor="isTeacher" className="text-sm font-normal text-slate-300">
                    Register as Teacher (Demo Mode)
                  </Label>
                </div>
              </>
            )}
            ...
            {isLogin && (
              <div className="mt-4 pt-4 border-t border-white/10 text-center">
                ...
                >
                  Are you a recruiter? Click here to autofill Demo Credentials.
                </button>
              </div>
            )}
